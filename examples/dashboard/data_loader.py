                ...
                rows.append(
                    {
                        ...
                        "confidence": self._safe_float(entry.get("confidence"), default=float("nan")),
                        "ood": self._safe_float(entry.get("ood"), default=float("nan")),
                        "stability": self._safe_float(entry.get("stability"), default=float("nan")),
                        "calibration": str(entry.get("calibration", "unknown")),
                        "explanation": self._safe_float(entry.get("explanation"), default=float("nan")),
                        "cbpe_score": self._safe_float(entry.get("cbpe_score"), default=float("nan")),
                        "risk_score": self._safe_float(entry.get("risk_score"), default=float("nan")),
